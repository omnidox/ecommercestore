...
<form action="admin_user_management.php">
    <input type="submit" value="Add/Delete Users">
</form>

<form action="admin_user_roles.php">
    <input type="submit" value="Assign Roles to Users">
</form>
